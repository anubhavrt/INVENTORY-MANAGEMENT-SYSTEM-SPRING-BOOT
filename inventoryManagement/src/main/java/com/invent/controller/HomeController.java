...
public class HomeController {
	...
	public String home(Model model) {
		//model.addAttribute("title","Home-inventory management system");
		return "home";
	}
	...
	public String about(Model model) {
		model.addAttribute("about","About-inventory management system");
		return "about";
	}
	...
	try {
		...
		if(!agreement) {
			System.out.println("Please check our terms and condition");
		...
		if(result1.hasErrors()) {
			...
			model.addAttribute("user",new User());
			session.setAttribute("message", new Message("succesfully rejistered", "alert-success"));
			return "signup";
